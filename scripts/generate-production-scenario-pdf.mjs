...
const SECTIONS = [
  ...
  {
    title: "TS-PROD-06 — HLP Packing (rangkuman)",
    items: [
      "[ ] /tablet/hlp -> pilih batch btc_ yang belum packing -> catat packsLolos, isiPerPack, reject + alasan.",
      "[ ] HARAPAN: total batang + berat/batang tampil; batch terkunci (1 batch = 1 kali catat).",
  ...
  {
    title: "TS-PROD-07 — Karton (Gudang Outbound)",
    items: [
      "[ ] Admin gudang: buat karton (kode, produk, kapasitas pack).",
      "[ ] \"Isi Pack\": pilih batch + packQty. HARAPAN: carton_content bertambah.",
      "[ ] NEGATIF: isi melebihi kapasitas -> CARTON_FULL.",
      "[ ] NEGATIF: packQty melebihi sisa packsLolos batch -> PACK_INSUFFICIENT.",
